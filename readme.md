...
<p>Projeto que utiliza a API do Github para criar um Card.</p>
...
$ git clone https://github.com/dimasdevspro/rocketcard

# Ainda no terminal, acesse as pastas onde salvou o repositório e com mais um comando
$ cd rocketcard
